...
import FriendPFP from './assets/FRIENDFRIEND.jpg'
const FriendsTab = () => {
  return (
...
const DirectMessages = () => {
  return (
    ...
    <div className= 'hover:bg-gray-700 py-2 px-3 rounded-lg'>
      <span className='flex items-center'>
      <img src={FriendPFP} className='rounded-3xl h-12 w-auto mr-5'/>
      <p className='text-lg'>Friend 1</p>
      </span>
    </div>    
    <div className= 'hover:bg-gray-700 py-2 px-3 rounded-lg'>
      <span className='flex items-center'>
      <img src={FriendPFP} className='rounded-3xl h-12 w-auto mr-5'/>
      <p className='text-lg'>Friend 2</p>
      </span>
    </div>
    <div className= 'hover:bg-gray-700 py-2 px-3 rounded-lg'>
      <span className='flex items-center'>
      <img src={FriendPFP} className='rounded-3xl h-12 w-auto mr-5'/>
      <p className='text-lg'>Friend 3</p>
      </span>
    </div>
    </div>
  )
